...
const Footer = () => {
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="https://twitter.com" className="hover:text-gray-400" aria-label="X (formerly Twitter)">
  <svg
    className="w-6 h-6"
    fill="currentColor"
    viewBox="0 0 24 24"
  ...
  >
    <path d="M17.657 3H6.343A3.342 3.342 0 003 6.343v11.314A3.342 3.342 0 006.343 21h11.314A3.342 3.342 0 0021 17.657V6.343A3.342 3.342 0 0017.657 3zm-1.66 7.191l-2.491 2.737 2.491 2.737a.564.564 0 01-.811.782L12 13.341l-3.687 3.306a.564.564 0 01-.811-.782l2.492-2.737-2.492-2.737a.564.564 0 01.811-.782L12 10.659l3.687-3.306a.564.564 0 11.81.782z" />
  </svg>
</a>
